...
# my train and test
# python main.py --model EDSR --scale 4 --save edsr_baseline_x4 --reset --pre_train "../models/edsr_baseline_x2-1bc95232.pt" --data_train Benchmark --data_test ade20k --patch_size 192 --epochs 51
# python main.py --data_test ade20k --scale 4 --pre_train "../experiment/edsr_baseline_x4/model/model_best.pt" --test_only --save_results
# python main.py --model EDSR --scale 4 --save edsr_baseline_x4 --load edsr_baseline_x4 --resume -1 --data_train Benchmark --data_test ade20k --patch_size 192 --epochs 101
python main.py --model EDSR --pre_train download --batch_size 64 --scale 4 --patch_size 96 --epochs 201 --reset --save_models
# python main.py --model EDSR --test_only --scale 4 --save_results