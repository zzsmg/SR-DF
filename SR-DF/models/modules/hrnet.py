...
BatchNorm2d = SynchronizedBatchNorm2d # 同步批归一化
BN_MOMENTUM = 0.1
...
class HRNetV2(nn.Module):
    ...
    def forward(self, x, return_feature_maps=False):
        ...
        # x = self.last_layer(x)
        return [x], z    # 这里的z就是我需要的多特征，后面会返回img_mfea
...
def hrnetv2(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        model_path = '/media/zz/Others/wk/Projects/SRMF/SRMF_5/trained_model/encoder_epoch_30.pth'
